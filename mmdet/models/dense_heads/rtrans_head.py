...
class rTransHead(FCOSHead):
    ...
    def init_weights(self):
        ...
        super(rTransHead, self).init_weights()
    ...
    def _init_layers(self):
        ...
        super(FCOSHead)._init_layers()
        self.conv_center_off = nn.Conv2d(self.feat_channels, 1, 2, padding=1)
    ...
    def forward_single(self, x, scale, stride):
        ...
        center_off = self.conv_center_off(reg_feat)
        ...
        return cls_score, bbox_pred, centerness, center_off
